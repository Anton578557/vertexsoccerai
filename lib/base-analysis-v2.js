...
const TEAM_IDS = { 'Nottingham Forest': '133720', 'Racing Club': '135170', 'Boca Juniors': '135156', 'Blaublitz Akita': '140509', 'Albirex Niigata': '139881', Nautico: '134289', 'Sport Recife': '136250', 'Independiente Medellin': '137613', Millonarios: '137617' };
...
async function findTeam(name, aliases = []) {
  try {
    const { payload } = await cachedProviderCall({
      cacheKey: `thesportsdb:team:v6:${safeKey(name)}`,
