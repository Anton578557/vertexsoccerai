...
const TEAM_IDS = { 'Cambridge United': '134586', 'AFC Wimbledon': '134241', 'Atletico Junior': '137615', 'Real Tomayapo': '140725', 'Nottingham Forest': '133720', 'Racing Club': '135170', 'Boca Juniors': '135156', 'Blaublitz Akita': '140509', 'Albirex Niigata': '139881', Nautico: '134289', 'Sport Recife': '136250', 'Independiente Medellin': '137613', Millonarios: '137617' };
...
async function findTeam(name, aliases = []) {
  try {
    const { payload } = await cachedProviderCall({
      cacheKey: `thesportsdb:team:v7:${safeKey(name)}`,
