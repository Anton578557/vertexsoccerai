...
function getPublicProviderStatus() {
  return Object.fromEntries(Object.entries(PROVIDERS).map(([key, provider]) => [key, {
    ...
    activeInAnalysis: ['footballData','apiFootball','theSportsDb','footballDataCoUk','openWeather','newsApi','sportmonks','wikidata','openFootball'].includes(key) || (key === 'espn' && isConfigured(key)),
