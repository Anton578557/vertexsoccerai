...
async function runSystemDiagnostics() {
  const [apiFootball, sportmonks, rapidApi, footballData, theSportsDb, openWeather, newsApi, supabase, resend, footballDataCoUk, openLigaDb, openMeteo, espn, wikidata, openFootball] = await Promise.all([
    checkApiFootball(),
    checkSportmonks(),
    checkRapidApi(),
    checkFootballData(),
  ...
  const providers = { apiFootball, sportmonks, rapidApi, footballData, theSportsDb, openWeather, newsApi, supabase, resend, footballDataCoUk, openLigaDb, openMeteo, espn, wikidata, openFootball };
  ...
  const footballKeys = ['apiFootball', 'sportmonks', 'rapidApi', 'footballData', 'espn', 'openFootball'];
