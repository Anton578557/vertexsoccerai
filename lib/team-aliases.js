...
const clubs = [
  ['Estudiantes La Plata',['Estudiantes L.P.','Estudiantes de La Plata','Эстудиантес Ла-Плата','Эстудиантес Ла Плата']],
  ['Atletico Tucuman',['Atl. Tucuman','Atlético Tucumán','Атлетико Тукуман']],
  ['Independiente Rivadavia',['Ind. Rivadavia','Independiente Rivadavia de Mendoza','Индепендьенте Ривадавия']],
  ['Union Saint-Gilloise',['St. Gilloise','Union Saint Gilloise','Royale Union Saint-Gilloise','Юнион Сент-Жиллуаз']],
  ['Sint-Truiden',['St Truiden','Sint Truiden','Sint-Truidense VV','Сент-Трюйден']],
  ['NEC Nijmegen',['Nijmegen','NEC','N.E.C. Nijmegen','НЕК Неймеген','Неймеген']],
  ['Vitoria Guimaraes',['Guimaraes','Vitória Guimarães','Vitoria SC','Vitória SC','Витория Гимарайнш']],
  ['Braga',['Sp Braga','Sporting Braga','SC Braga','Брага']],
  ['Goztepe',['Goztep','Göztepe','Göztepe SK','Гёзтепе','Гезтепе']],
  ['Amedspor',['Amed','Amed SK','Amed S.F.K.','Amed Sportif Faaliyetler','Амедспор']],
  ['Kalamata',['Kalamata F.C.','Kalamata Football Club','Kalamata FC','Каламата']],
  ['AZ Alkmaar', ['AZ','АЗ Алкмар','АЗ']],
  ['Olympiacos', ['Olympiakos','Olympiakos Piraeus','Olympiacos Piraeus','Olympiacos FC','Олимпиакос']],
  ['Levadiakos', ['Levadeiakos','Levadiakos FC','Левадиакос']],
  ['AEK Athens', ['AEK','AEK Athens FC','АЕК','АЕК Афины']],
  ['OFI Crete', ['OFI','OFI Crete FC','ОФИ','ОФИ Крит']],
  ['Volos', ['Volos NFC','Volos NPS','Волос']],
  ['St Johnstone', ['St. Johnstone','Saint Johnstone','Сент-Джонстон']],
  ['Frosinone', ['Frosinone Calcio','Фрозиноне']],
  ['Bolton Wanderers', ['Bolton','Болтон','Болтон Уондерерс']],
  ...
  ['Roma', ['рома']],
  ['Lazio', ['лацио']],
  ['Atalanta', ['аталанта','Atalanta BC','Atalanta Bergamasca Calcio']],
  ...
  ['Cagliari', ['кальяри']],
  ['Lecce', ['лечче']],
  ['Parma', ['парма','Parma Calcio 1913']],
  ['Como', ['комо','Como 1907']],
  ['Hellas Verona', ['верона', 'хеллас верона']],
  ['Empoli', ['эмполи']],

  ['Paris Saint-Germain', ['псж', 'пари сен жермен', 'пари сен-жермен', 'psg','Paris SG']],
