...
const additionalAliases = {
  'Atletico Madrid': ['Atlético de Madrid', 'Club Atlético de Madrid'],
  'Bayer Leverkusen': ['Bayer 04 Leverkusen'],
  'Bayern Munich': ['Bayern Múnich', 'Bayern de Múnich', 'FC Bayern München'],
  'Manchester City': ['Mánchester City'],
  'Manchester United': ['Mánchester United'],
  'Borussia Monchengladbach': ['Borussia Mönchengladbach', 'Borussia Mönchengladbach 1900'],
  ...
  'Coventry City': ['Ковэнтри Сити', 'Ковэнтри'],
  'Havelse': ['Хавельзэ'],
