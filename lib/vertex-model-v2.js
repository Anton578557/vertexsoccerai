...
const MODEL_VERSION = 'Vertex Model 2.2';
...
function finalizeVertexModelV2(analysis) {
  ...
  const accessLimited = Object.values(analysis.sourceStatus || {}).some(value => /account_suspended|quota_exhausted|teams_not_available_in_plan|access_denied/.test(String(value)));
