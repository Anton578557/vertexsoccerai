...
(function (root, factory) {
  ...
  const entries = [
    ...
    ['Confirmed starting lineups are unavailable for this fixture.','Подтверждённые стартовые составы для этого матча недоступны.','Las alineaciones iniciales confirmadas no están disponibles para este partido.'],
    ['The injury list is incomplete; missing records do not mean every player is available.','Список травм неполный; отсутствие сведений не означает, что все игроки доступны.','La lista de lesiones es incompleta; la ausencia de datos no significa que todos los jugadores estén disponibles.'],
    ['no_relevant_news','Подходящих новостей не найдено','No se han encontrado noticias relevantes'],
